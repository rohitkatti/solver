...
/* @@protoc_insertion_point(class_definition:health.v1.Response) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "health.v1.Response"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:health.v1.Response)
 private:
  class _Internal;
...
inline bool Response::healthy() const {
  // @@protoc_insertion_point(field_get:health.v1.Response.healthy)
  return _internal_healthy();
}
inline void Response::set_healthy(bool value) {
  _internal_set_healthy(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  // @@protoc_insertion_point(field_set:health.v1.Response.healthy)
}
